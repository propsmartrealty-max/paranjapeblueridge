    ...
    <main className="bg-navy text-text selection:bg-gold selection:text-navy">
      ...
      <section className="relative h-screen flex items-center overflow-hidden">
        <div className="absolute inset-0 z-0">
          <img src="/assets/images/master-hero-v1.png" className="w-full h-full object-cover opacity-40 grayscale-[0.2]" alt="Paranjape Blue Ridge Hinjewadi Phase 1 - 138 Acre Integrated Township Night Panorama" />
