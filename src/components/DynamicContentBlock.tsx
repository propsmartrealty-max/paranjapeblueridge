...
export default function DynamicContentBlock({ silo, title }: DynamicContentBlockProps) {
  ...
  const renderContent = () => {
    switch (silo) {
      ...
      case 'west-pune-macro':
        return (
          <>
            <h3 className="text-2xl font-serif text-[#070D1A] mb-4">Understanding the Pune Real Estate Market Landscape</h3>
            ...
            <h4 className="text-xl font-serif text-[#8F6A24] mb-3">Why West Pune is the Epicenter of Luxury Real Estate</h4>
            <p className="text-slate-600 mb-6">
            ...
            <h4 className="text-xl font-serif text-[#8F6A24] mb-3">Capital Appreciation and Rental Yield Dynamics</h4>
            <p className="text-slate-600 mb-6">
            ...
            <h4 className="text-xl font-serif text-[#8F6A24] mb-3">The Infrastructure Catalyst: Pune Metro Line 3</h4>
            <p className="text-slate-600 mb-6">
            ...
            <h4 className="text-xl font-serif text-[#8F6A24] mb-3">Pune Growth Corridors: West Pune vs. East Pune Comparison</h4>
            ...
            <div className="overflow-x-auto my-6 border border-slate-200 rounded-2xl">
              <table className="min-w-full text-left text-xs text-slate-600">
                <thead className="bg-slate-100 text-[#B88E3E] font-bold uppercase tracking-widest border-b border-slate-200">
                  <tr>
                ...
                <tbody className="divide-y divide-white/5 bg-white">
                  <tr>
                    <td className="px-6 py-4 font-bold text-[#070D1A]">Primary Tech Hubs</td>
                  ...
                  <tr>
                    <td className="px-6 py-4 font-bold text-[#070D1A]">Average Rental Yield</td>
                  ...
                  <tr>
                    <td className="px-6 py-4 font-bold text-[#070D1A]">Avg. Capital Appreciation</td>
                    <td className="px-6 py-4 text-emerald-400">12% - 15% YoY (Metro Proximity Boost)</td>
                    <td className="px-6 py-4">8% - 11% YoY</td>
                  </tr>
                  <tr>
                    <td className="px-6 py-4 font-bold text-[#070D1A]">Mass Transit Line</td>
                  ...
                  <tr>
                    <td className="px-6 py-4 font-bold text-[#070D1A]">Ecosystem Integration</td>
            ...
            <h4 className="text-xl font-serif text-[#8F6A24] mb-3">The Township Advantage vs. Standalone Projects</h4>
            <p className="text-slate-600 mb-6">
      ...
      case 'competitors':
        return (
          <>
            <h3 className="text-2xl font-serif text-[#070D1A] mb-4">Objective Comparison: Why {title} Matters</h3>
            <p className="text-slate-600 mb-6">
            ...
            <h4 className="text-xl font-serif text-[#8F6A24] mb-3">Scale and Ready Infrastructure</h4>
            <p className="text-slate-600 mb-6">
            ...
            <h4 className="text-xl font-serif text-[#8F6A24] mb-3">Township Masterplan Comparison Matrix</h4>
            <div className="overflow-x-auto my-6 border border-slate-200 rounded-2xl">
              <table className="min-w-full text-left text-xs text-slate-600">
                <thead className="bg-slate-100 text-[#B88E3E] font-bold uppercase tracking-widest border-b border-slate-200">
                  <tr>
                ...
                <tbody className="divide-y divide-white/5 bg-white">
                  <tr>
                    <td className="px-6 py-4 font-bold text-[#070D1A]">Total Land Area</td>
                  ...
                  <tr>
                    <td className="px-6 py-4 font-bold text-[#070D1A]">Location Zone</td>
                  ...
                  <tr>
                    <td className="px-6 py-4 font-bold text-[#070D1A]">9-Hole Golf Course</td>
                  ...
                  <tr>
                    <td className="px-6 py-4 font-bold text-[#070D1A]">ICSE School Inside</td>
                  ...
                  <tr>
                    <td className="px-6 py-4 font-bold text-[#070D1A]">Private Boat Club</td>
                  ...
                  <tr>
                    <td className="px-6 py-4 font-bold text-[#070D1A]">Power & Water Security</td>
      ...
      case 'tech-parks':
        return (
          <>
            <h3 className="text-2xl font-serif text-[#070D1A] mb-4">The Strategic Advantage of Proximity to {title}</h3>
            <p className="text-slate-600 mb-6">
            ...
            <h4 className="text-xl font-serif text-[#8F6A24] mb-3">Economic Resilience and High Liquidity</h4>
            <p className="text-slate-600 mb-6">
      ...
      case 'price-list':
        return (
          <>
            <h3 className="text-2xl font-serif text-[#070D1A] mb-4">Investment Analysis: Maximizing ROI with {title}</h3>
            <p className="text-slate-600 mb-6">
            ...
            <h4 className="text-xl font-serif text-[#8F6A24] mb-3">Rental Yields and Tenant Demographics</h4>
            <p className="text-slate-600 mb-6">
            ...
            <h4 className="text-xl font-serif text-[#8F6A24] mb-3">Hinjewadi Phase 1 Residential Yield Matrix (2026 Index)</h4>
            <div className="overflow-x-auto my-6 border border-slate-200 rounded-2xl">
              <table className="min-w-full text-left text-xs text-slate-600">
                <thead className="bg-slate-100 text-[#B88E3E] font-bold uppercase tracking-widest border-b border-slate-200">
                  <tr>
                ...
                <tbody className="divide-y divide-white/5 bg-white">
                  <tr>
                    <td className="px-6 py-4 font-bold text-[#070D1A]">2 BHK Smart Flat</td>
                  ...
                  <tr>
                    <td className="px-6 py-4 font-bold text-[#070D1A]">3 BHK Premium Flat</td>
                  ...
                  <tr>
                    <td className="px-6 py-4 font-bold text-[#070D1A]">4 BHK Luxury Apartment</td>
      ...
      case 'hinjewadi-market':
        return (
          <>
            <h3 className="text-2xl font-serif text-[#070D1A] mb-4">Hinjewadi Real Estate: The Definitive Market Guide for {title}</h3>
            <p className="text-slate-600 mb-6">
            ...
            <h4 className="text-xl font-serif text-[#8F6A24] mb-3">Why Hinjewadi Phase 1 Commands a Premium</h4>
            <p className="text-slate-600 mb-6">
            ...
            <h4 className="text-xl font-serif text-[#8F6A24] mb-3">Key Infrastructure Connectivity Index (Hinjewadi Phase 1 Hub)</h4>
            <div className="overflow-x-auto my-6 border border-slate-200 rounded-2xl">
              <table className="min-w-full text-left text-xs text-slate-600">
                <thead className="bg-slate-100 text-[#B88E3E] font-bold uppercase tracking-widest border-b border-slate-200">
                  <tr>
                ...
                <tbody className="divide-y divide-white/5 bg-white">
                  <tr>
                    <td className="px-6 py-4 font-bold text-[#070D1A]">Metro Line 3 Station</td>
                  ...
                  <tr>
                    <td className="px-6 py-4 font-bold text-[#070D1A]">Mumbai-Pune Expressway</td>
                  ...
                  <tr>
                    <td className="px-6 py-4 font-bold text-[#070D1A]">Balewadi High Street</td>
                  ...
                  <tr>
                    <td className="px-6 py-4 font-bold text-[#070D1A]">Blue Ridge Public School</td>
            ...
            <h4 className="text-xl font-serif text-[#8F6A24] mb-3">The 2026 Buyer Profile: Data-Driven Decisions</h4>
            <p className="text-slate-600 mb-6">
            ...
            <h4 className="text-xl font-serif text-[#8F6A24] mb-3">Metro Line 3: The Final Catalyst</h4>
            <p className="text-slate-600 mb-6">
      ...
      case 'township':
        return (
          <>
            <h3 className="text-2xl font-serif text-[#070D1A] mb-4">The Township Revolution: Why {title} Defines Modern Living</h3>
            <p className="text-slate-600 mb-6">
            ...
            <h4 className="text-xl font-serif text-[#8F6A24] mb-3">Blue Ridge: Pune's Premier 138-Acre Integrated Township</h4>
            <p className="text-slate-600 mb-6">
            ...
            <h4 className="text-xl font-serif text-[#8F6A24] mb-3">Township vs. Standalone: The Investment Mathematics</h4>
            <p className="text-slate-600 mb-6">
      ...
      case 'buyer-intent':
        return (
          <>
            <h3 className="text-2xl font-serif text-[#070D1A] mb-4">Your Guide to Securing {title}</h3>
            <p className="text-slate-600 mb-6">
            ...
            <h4 className="text-xl font-serif text-[#8F6A24] mb-3">The Blue Ridge Advantage for {title}</h4>
            <p className="text-slate-600 mb-6">
            ...
            <h4 className="text-xl font-serif text-[#8F6A24] mb-3">NRI Investment Considerations</h4>
            <p className="text-slate-600 mb-6">
      ...
      case 'location':
        return (
          <>
            <h3 className="text-2xl font-serif text-[#070D1A] mb-4">Why Location Within Pune Determines Your Property's Future: {title}</h3>
            <p className="text-slate-600 mb-6">
            ...
            <h4 className="text-xl font-serif text-[#8F6A24] mb-3">The Hinjewadi-Wakad-Baner Belt: Pune's Golden Triangle</h4>
            <p className="text-slate-600 mb-6">
            ...
            <h4 className="text-xl font-serif text-[#8F6A24] mb-3">Proximity Advantages That Define {title}</h4>
            <p className="text-slate-600 mb-6">
            ...
            <h4 className="text-xl font-serif text-[#8F6A24] mb-3">Social Infrastructure Within a 3 KM Radius</h4>
            <p className="text-slate-600 mb-6">
            ...
            <h4 className="text-xl font-serif text-[#8F6A24] mb-3">The Scarcity Premium: No More Large Land Parcels in Hinjewadi Phase 1</h4>
            <p className="text-slate-600 mb-6">
      ...
      case 'infra-guide':
        return (
          <>
            <h3 className="text-2xl font-serif text-[#070D1A] mb-4">Infrastructure Transformation Driving {title} Valuations</h3>
            <p className="text-slate-600 mb-6">
            ...
            <h4 className="text-xl font-serif text-[#8F6A24] mb-3">Pune Metro Line 3: The Game-Changing Catalyst</h4>
            <p className="text-slate-600 mb-6">
            ...
            <h4 className="text-xl font-serif text-[#8F6A24] mb-3">Hinjewadi-Wakad Flyover and Road Network Upgrades</h4>
            <p className="text-slate-600 mb-6">
            ...
            <h4 className="text-xl font-serif text-[#8F6A24] mb-3">Mumbai-Pune Expressway and Ring Road Connectivity</h4>
            <p className="text-slate-600 mb-6">
            ...
            <h4 className="text-xl font-serif text-[#8F6A24] mb-3">Smart City Infrastructure and Digital Backbone</h4>
            <p className="text-slate-600 mb-6">
      ...
      case 'ecosystem':
        return (
          <>
            <h3 className="text-2xl font-serif text-[#070D1A] mb-4">The Blue Ridge Ecosystem: Why {title} Offers an Unmatched Living Experience</h3>
            <p className="text-slate-600 mb-6">
            ...
            <h4 className="text-xl font-serif text-[#8F6A24] mb-3">The 9-Hole Golf Course: A Lifestyle Statement</h4>
            <p className="text-slate-600 mb-6">
            ...
            <h4 className="text-xl font-serif text-[#8F6A24] mb-3">Private Boat Club on the Mula River</h4>
            <p className="text-slate-600 mb-6">
            ...
            <h4 className="text-xl font-serif text-[#8F6A24] mb-3">Blue Ridge Public School (ICSE): Education at Your Doorstep</h4>
            <p className="text-slate-600 mb-6">
            ...
            <h4 className="text-xl font-serif text-[#8F6A24] mb-3">Sports, Wellness, and Commercial Ecosystem</h4>
            <p className="text-slate-600 mb-6">
      ...
      case 'competitor':
        return (
          <>
            <h3 className="text-2xl font-serif text-[#070D1A] mb-4">Objective Analysis: Why Blue Ridge Outperforms Alternatives for {title}</h3>
            <p className="text-slate-600 mb-6">
            ...
            <h4 className="text-xl font-serif text-[#8F6A24] mb-3">The 138-Acre Scale Advantage</h4>
            <p className="text-slate-600 mb-6">
            ...
            <h4 className="text-xl font-serif text-[#8F6A24] mb-3">Mature vs. Promised Infrastructure</h4>
            <p className="text-slate-600 mb-6">
            ...
            <h4 className="text-xl font-serif text-[#8F6A24] mb-3">Developer Credibility: The Paranjape Advantage</h4>
            <p className="text-slate-600 mb-6">
            ...
            <h4 className="text-xl font-serif text-[#8F6A24] mb-3">Resale Value and Exit Liquidity</h4>
            <p className="text-slate-600 mb-6">
      ...
      case 'amenities':
        return (
          <>
            <h3 className="text-2xl font-serif text-[#070D1A] mb-4">Premium Gated Community Living: {title} at Blue Ridge</h3>
            <p className="text-slate-600 mb-6">
            ...
            <h4 className="text-xl font-serif text-[#8F6A24] mb-3">Multi-Tier Security Architecture</h4>
            <p className="text-slate-600 mb-6">
            ...
            <h4 className="text-xl font-serif text-[#8F6A24] mb-3">40+ Lifestyle Amenities Across the Township</h4>
            <p className="text-slate-600 mb-6">
            ...
            <h4 className="text-xl font-serif text-[#8F6A24] mb-3">Green Spaces and Environmental Design</h4>
            <p className="text-slate-600 mb-6">
            ...
            <h4 className="text-xl font-serif text-[#8F6A24] mb-3">Community Engagement and Social Life</h4>
            <p className="text-slate-600 mb-6">
      ...
      case 'floor-plan':
        return (
          <>
            <h3 className="text-2xl font-serif text-[#070D1A] mb-4">Architectural Excellence and Space Planning: {title}</h3>
            <p className="text-slate-600 mb-6">
            ...
            <h4 className="text-xl font-serif text-[#8F6A24] mb-3">MiVAN Aluminium Formwork Construction</h4>
            <p className="text-slate-600 mb-6">
            ...
            <h4 className="text-xl font-serif text-[#8F6A24] mb-3">Carpet Area Configurations Under RERA</h4>
            <p className="text-slate-600 mb-6">
            ...
            <h4 className="text-xl font-serif text-[#8F6A24] mb-3">Vastu-Compliant Design Philosophy</h4>
            <p className="text-slate-600 mb-6">
            ...
            <h4 className="text-xl font-serif text-[#8F6A24] mb-3">Smart Home Readiness and Future-Proofing</h4>
            <p className="text-slate-600 mb-6">
      ...
      case 'site-visit':
        return (
          <>
            <h3 className="text-2xl font-serif text-[#070D1A] mb-4">Planning Your Site Visit: Experience {title} First-Hand</h3>
            <p className="text-slate-600 mb-6">
            ...
            <h4 className="text-xl font-serif text-[#8F6A24] mb-3">The Blue Ridge Sales Gallery Experience</h4>
            <p className="text-slate-600 mb-6">
            ...
            <h4 className="text-xl font-serif text-[#8F6A24] mb-3">Model Flat Walkthrough</h4>
            <p className="text-slate-600 mb-6">
            ...
            <h4 className="text-xl font-serif text-[#8F6A24] mb-3">Township Tour: What You'll Experience</h4>
            <p className="text-slate-600 mb-6">
            ...
            <h4 className="text-xl font-serif text-[#8F6A24] mb-3">Booking Your Visit</h4>
            <p className="text-slate-600 mb-6">
      ...
      case 'towers':
        return (
          <>
            <h3 className="text-2xl font-serif text-[#070D1A] mb-4">Blue Ridge Tower Architecture: Understanding {title}</h3>
            <p className="text-slate-600 mb-6">
            ...
            <h4 className="text-xl font-serif text-[#8F6A24] mb-3">A Legacy of 26 Towers: The Blue Ridge Skyline</h4>
            <p className="text-slate-600 mb-6">
            ...
            <h4 className="text-xl font-serif text-[#8F6A24] mb-3">Panoramic Views: The Premium You Live With Daily</h4>
            <p className="text-slate-600 mb-6">
            ...
            <h4 className="text-xl font-serif text-[#8F6A24] mb-3">Tower Amenities and Podium Design</h4>
            <p className="text-slate-600 mb-6">
            ...
            <h4 className="text-xl font-serif text-[#8F6A24] mb-3">Seismic Safety and Structural Engineering</h4>
            <p className="text-slate-600 mb-6">
      ...
      case 'clusters':
        return (
          <>
            <h3 className="text-2xl font-serif text-[#070D1A] mb-4">Blue Ridge Residential Clusters: Finding Your Perfect {title}</h3>
            <p className="text-slate-600 mb-6">
            ...
            <h4 className="text-xl font-serif text-[#8F6A24] mb-3">Ridges 41: The Smart Value Proposition</h4>
            <p className="text-slate-600 mb-6">
            ...
            <h4 className="text-xl font-serif text-[#8F6A24] mb-3">Promenade Residences: The Premium Mid-Segment</h4>
            <p className="text-slate-600 mb-6">
            ...
            <h4 className="text-xl font-serif text-[#8F6A24] mb-3">The Altius: Ultra-Premium Sky Living</h4>
            <p className="text-slate-600 mb-6">
            ...
            <h4 className="text-xl font-serif text-[#8F6A24] mb-3">Legacy Clusters: Orion and Groves</h4>
            <p className="text-slate-600 mb-6">
      ...
      case 'luxury-west-pune':
        return (
          <>
            <h3 className="text-2xl font-serif text-[#070D1A] mb-4">West Pune: The Luxury Real Estate Epicenter for {title}</h3>
            <p className="text-slate-600 mb-6">
            ...
            <h4 className="text-xl font-serif text-[#8F6A24] mb-3">The Economic Engine: IT Corridors Driving Premium Demand</h4>
            <p className="text-slate-600 mb-6">
            ...
            <h4 className="text-xl font-serif text-[#8F6A24] mb-3">Lifestyle Corridors: Baner, Balewadi, and Beyond</h4>
            <p className="text-slate-600 mb-6">
            ...
            <h4 className="text-xl font-serif text-[#8F6A24] mb-3">Price Trajectory: Where West Pune is Heading</h4>
            <p className="text-slate-600 mb-6">
            ...
            <h4 className="text-xl font-serif text-[#8F6A24] mb-3">The NRI and HNI Migration Pattern</h4>
            <p className="text-slate-600 mb-6">
      ...
      case 'transactions':
        return (
          <>
            <h3 className="text-2xl font-serif text-[#070D1A] mb-4">The Complete Buying Guide: Securing {title} at Blue Ridge</h3>
            <p className="text-slate-600 mb-6">
            ...
            <h4 className="text-xl font-serif text-[#8F6A24] mb-3">RERA Compliance: Your Legal Shield</h4>
            <p className="text-slate-600 mb-6">
            ...
            <h4 className="text-xl font-serif text-[#8F6A24] mb-3">Home Loan Options and Financial Planning</h4>
            <p className="text-slate-600 mb-6">
            ...
            <h4 className="text-xl font-serif text-[#8F6A24] mb-3">Transaction Costs: A Complete Breakdown</h4>
            <p className="text-slate-600 mb-6">
            ...
            <h4 className="text-xl font-serif text-[#8F6A24] mb-3">Pune Residential Real Estate Transaction Tax Structure (2026 Checklist)</h4>
            <div className="overflow-x-auto my-6 border border-slate-200 rounded-2xl">
              <table className="min-w-full text-left text-xs text-slate-600">
                <thead className="bg-slate-100 text-[#B88E3E] font-bold uppercase tracking-widest border-b border-slate-200">
                  <tr>
                ...
                <tbody className="divide-y divide-white/5 bg-white">
                  <tr>
                    <td className="px-6 py-4 font-bold text-[#070D1A]">Stamp Duty</td>
                  ...
                  <tr>
                    <td className="px-6 py-4 font-bold text-[#070D1A]">Registration Charges</td>
                  ...
                  <tr>
                    <td className="px-6 py-4 font-bold text-[#070D1A]">GST (Goods & Services Tax)</td>
                  ...
                  <tr>
                    <td className="px-6 py-4 font-bold text-[#070D1A]">TDS (Tax Deducted at Source)</td>
            ...
            <h4 className="text-xl font-serif text-[#8F6A24] mb-3">Documentation Checklist for Buyers</h4>
            <p className="text-slate-600 mb-6">
      ...
      case 'regional-mr':
        return (
          <>
            <h3 className="text-2xl font-serif text-[#070D1A] mb-4">परांजपे ब्ल्यू रिज हिंजवडी: {title}</h3>
            <p className="text-slate-600 mb-6">
            ...
            <h4 className="text-xl font-serif text-[#8F6A24] mb-3">टाउनशिपची प्रमुख वैशिष्ट्ये</h4>
            <p className="text-slate-600 mb-6">
            ...
            <h4 className="text-xl font-serif text-[#8F6A24] mb-3">उपलब्ध सदनिका आणि किंमत श्रेणी</h4>
            <p className="text-slate-600 mb-6">
            ...
            <h4 className="text-xl font-serif text-[#8F6A24] mb-3">हिंजवडीचे स्थान लाभ</h4>
            <p className="text-slate-600 mb-6">
            ...
            <h4 className="text-xl font-serif text-[#8F6A24] mb-3">गुंतवणूक आणि भाडे उत्पन्न</h4>
            <p className="text-slate-600 mb-6">
      ...
      case 'paranjape-schemes':
        return (
          <>
            <h3 className="text-2xl font-serif text-[#070D1A] mb-4">Paranjape Schemes (Construction) Ltd: Setting Benchmarks in Pune Real Estate</h3>
            <p className="text-slate-600 mb-6">
            ...
            <h4 className="text-xl font-serif text-[#8F6A24] mb-3">Athashri: The Pioneer of Senior Citizen Housing in Pune</h4>
            <p className="text-slate-600 mb-6">
            ...
            <h4 className="text-xl font-serif text-[#8F6A24] mb-3">Forest Trails: Pune's Premier Villa Township in Bhugaon</h4>
            <p className="text-slate-600 mb-6">
            ...
            <h4 className="text-xl font-serif text-[#8F6A24] mb-3">Trident Towers, Opulus, and Highgardens</h4>
            <p className="text-slate-600 mb-6">
      ...
      case 'maintenance-concerns':
        return (
          <>
            <h3 className="text-2xl font-serif text-[#070D1A] mb-4">Paranjape Blue Ridge Maintenance & Infrastructure: Honest Assessment of {title}</h3>
            <p className="text-slate-600 mb-6">
            ...
            <h4 className="text-xl font-serif text-[#8F6A24] mb-3">Water Quality, Supply, and Traffic Management</h4>
            <p className="text-slate-600 mb-6">
      ...
      case 'resale-rental':
        return (
          <>
            <h3 className="text-2xl font-serif text-[#070D1A] mb-4">Resale and Rental Market Performance: {title}</h3>
            <p className="text-slate-600 mb-6">
            ...
            <h4 className="text-xl font-serif text-[#8F6A24] mb-3">Secondary Market Liquidity & Capital Growth</h4>
            <p className="text-slate-600 mb-6">
      ...
      case 'calculators':
        return (
          <>
            <h3 className="text-2xl font-serif text-[#070D1A] mb-4">EMI Planning and Financial Analysis: {title}</h3>
            <p className="text-slate-600 mb-6">
            ...
            <h4 className="text-xl font-serif text-[#8F6A24] mb-3">ROI and Cost Breakup Analysis</h4>
            <p className="text-slate-600 mb-6">
      ...
      case 'paa-reviews':
        return (
          <>
            <h3 className="text-2xl font-serif text-[#070D1A] mb-4">Honest Resident Feedback and Reviews: {title}</h3>
            <p className="text-slate-600 mb-6">
            ...
            <h4 className="text-xl font-serif text-[#8F6A24] mb-3">Evaluating Pros & Cons</h4>
            <p className="text-slate-600 mb-6">
      ...
      default:
        return (
          <>
            <h3 className="text-2xl font-serif text-[#070D1A] mb-4">Elevating Your Lifestyle with {title}</h3>
            <p className="text-slate-600 mb-6">
            ...
            <h4 className="text-xl font-serif text-[#8F6A24] mb-3">A Community of Like-Minded Achievers</h4>
            <p className="text-slate-600 mb-6">
  ...
  return (
    <div className="bg-slate-50 border-t border-b border-gold/10 py-24">
      <div className="container max-w-4xl mx-auto">
        <div className="flex items-center gap-4 text-[#B88E3E] font-bold tracking-[4px] uppercase text-[10px] mb-8">
