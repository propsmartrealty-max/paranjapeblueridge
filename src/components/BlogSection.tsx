        ...
        {articles.slice(0, 3).map((article, idx) => (
          ...
          >
            <a 
              ...
              className="group cursor-pointer block p-6 ultra-glass-card border border-gold/25 rounded-3xl hover:border-gold/60 transition-all shadow-lg hover:shadow-2xl relative overflow-hidden hud-frame h-full flex flex-col justify-between no-underline"
            >
