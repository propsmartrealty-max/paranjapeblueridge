  ...
  return (
    <section id="amenities" className="py-20 relative overflow-hidden">
      <div className="text-center mb-20">
        ...
        <h2 className="text-5xl font-serif text-warm-white mt-4">{t('Integrated', 'इंटिग्रेटेड')} <span className="italic font-normal text-gilded">{t('Grandeur', 'ग्रँड्युअर')}</span></h2>
      </div>
      ...
      <div className="mt-32 relative h-[50vh] min-h-[500px] md:h-[600px] rounded-[3rem] overflow-hidden group">
         ...
         <div className="absolute inset-0 flex items-center p-20">
            <div className="max-w-xl">
                <h3 className="text-5xl font-serif text-warm-white mb-8 leading-tight">A Life <span className="italic text-gilded">Beyond</span> Ordinary</h3>
                ...
                <div className="flex gap-10">
                    <div>
                        <span className="text-4xl font-serif text-gilded block">1.5 KM</span>
                        <span className="text-[10px] text-text-light uppercase tracking-widest">Riverfront Access</span>
                    </div>
                    <div className="border-l border-white/10 pl-10">
                        <span className="text-4xl font-serif text-gilded block">9-Hole</span>
