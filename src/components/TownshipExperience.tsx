  ...
  return (
    <section id="amenities" className="py-24 relative overflow-hidden">
        ...
        {townshipData.amenities.map((item, idx) => {
          ...
          return (
            <motion.div 
              ...
              viewport={{ once: true }}
              className="p-8 sm:p-10 ultra-glass-card border border-gold/25 rounded-[2.5rem] hover:border-gold/60 transition-all text-center group shadow-lg hover:shadow-2xl relative overflow-hidden"
            >
              <div className="absolute top-0 left-0 w-full h-1 bg-gradient-to-r from-transparent via-gold/50 to-transparent"></div>
              
              <div className="w-16 h-16 bg-gradient-to-br from-gold/20 to-gold/5 rounded-2xl flex items-center justify-center text-gold mx-auto mb-6 group-hover:scale-110 group-hover:bg-gold group-hover:text-navy transition-all border border-gold/25 shadow-md">
                <IconComp size={28} />
              </div>
              <h3 className="text-xl sm:text-2xl font-serif text-warm-white font-bold mb-3">{item.title}</h3>
              <p className="text-text-muted text-xs sm:text-sm leading-relaxed">{item.description}</p>
            </motion.div>
          );
        })}
      </div>
      ...
      <motion.div 
        ...
        viewport={{ once: true }}
        className="mt-24 relative min-h-[450px] md:h-[550px] rounded-[2.5rem] sm:rounded-[3.5rem] overflow-hidden border border-gold/30 shadow-2xl group"
      >
        <Image 
        ...
        <div className="absolute inset-0 flex items-center p-8 sm:p-14 lg:p-20">
          <div className="max-w-xl">
            <span className="gilded-pill text-[9px] mb-3 bg-black/40 text-gold border-gold/40">Sovereign Lifestyle</span>
            ...
            <p className="text-white/80 text-xs sm:text-base mb-8 leading-relaxed">
            ...
            <div className="flex flex-wrap gap-8">
              <div className="p-4 bg-black/40 backdrop-blur-md rounded-2xl border border-gold/30">
                <span className="text-2xl sm:text-3xl font-serif text-gilded font-bold block leading-none">1.5 KM</span>
                <span className="text-[9px] text-white/70 uppercase tracking-widest font-semibold mt-1 block">Riverfront Access</span>
              </div>
              <div className="p-4 bg-black/40 backdrop-blur-md rounded-2xl border border-gold/30">
                <span className="text-2xl sm:text-3xl font-serif text-gilded font-bold block leading-none">9-Hole</span>
                <span className="text-[9px] text-white/70 uppercase tracking-widest font-semibold mt-1 block">Private Golf Course</span>
              </div>
            </div>
          </div>
        </div>
