      ...
      <div className="container mx-auto px-4 sm:px-6 max-w-7xl relative z-10">
        ...
        <div className="flex flex-wrap items-center gap-2.5 mb-10 pb-4 border-b border-slate-200">
          <button
            ...
            className={`px-5 py-2 rounded-full text-xs font-sans font-bold uppercase tracking-wider transition-all cursor-pointer ${
              selectedFilter === 'all'
                ? 'bg-[#785415] text-white border-2 border-[#785415] shadow-sm'
        ...
        >
          {filteredClusters.map((cluster) => (
            ...
            >
              <div className="glass-card-luxury p-4 flex flex-col h-full">
                ...
                <div className="relative h-72 sm:h-80 rounded-2xl overflow-hidden bg-slate-100 mb-4">
                  ...
                  <div className="absolute top-3 left-3 right-3 flex flex-wrap items-center justify-between gap-1.5 pointer-events-none">
                    <span className="glass-pill px-2.5 py-1 rounded-full text-[10px] font-mono uppercase tracking-wider text-[#070D1A] font-bold max-w-[65%] truncate">
                      {cluster.configurations}
                    </span>
                    <span className="glass-pill px-2.5 py-1 rounded-full text-[10px] font-mono uppercase tracking-wider text-slate-800 font-bold shrink-0">
                ...
                <div className="p-2 flex flex-col justify-between flex-grow space-y-4">
                  ...
                  {/* High-Contrast Frosted Real Estate Metrics Box */}
                  <div className="p-3.5 rounded-2xl bg-white/75 backdrop-blur-md border border-slate-200/90 shadow-xs grid grid-cols-2 gap-3">
                    <div>
